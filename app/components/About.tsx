...
const About = () => {
    return <section className={`section-Center `}>
        ...
        <div className={`flex flex-wrap px-10 justify-between overflow-hidden w-full maxW`}>
            <div className={`w-[40%] min-w-[700px] selection:bg-purple-500 selection:text-primary left mb-20`}>
                <div className={`flex items-center gap-5 mb-10`}>
                    <div className={`relative border-2 border-purple-500`}>
                        <BigUserSVG />
                    ...
                    <div className={`text-6xl ${blackOpsOne.className} antialiased gap-2 border-2 flex border-blue-500 items-center p-2 relative`}>
                ...
                <p className={`text-2xl text-secondary appear`}>
                    Hallo! Ich bin Florian, ein Student an der Kantonsschule Sargans. Nebenbei Programmiere ich Hobbymässig Webseiten.
                </p>
            </div>
            <div className={`w-[40%] right min-w-[400px] bg-darkBg border-2 border-lightBG rounded-2xl relative selection:bg-zinc-600 mb-20 max-[1250px]:w-full`}>
