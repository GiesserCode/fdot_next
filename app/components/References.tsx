...
import {FdotSVG, LockSVG} from "@/app/ui/SVG";
...
const References = () => {
    ...
    return <section className={`w-full overflow-hidden relative grid place-items-center`}>
        ...
        <div className={`w-10/12 p-10 flex justify-between max-[1250px]:flex-wrap max-[1250px]:w-full maxW`}>
            <div className={`w-[50%] max-w-[60%] min-w-[400px] h-[500px] relative overflow-auto lg:mr-5 bg-darkBg border-2 border-lightBG rounded-2xl my-10 selection:bg-zinc-600 max-[1250px]:w-full max-[1250px]:max-w-full max-[1250px]:order-2 max-lg:min-w-0`}>
                <div className={`overflow-hidden w-full h-full flex flex-col rounded-2xl`}>
                    ...
                    <div className={`w-full h-full relative`}>
                        ...
                        : <div className={`grid place-items-center h-full`}><div className={`grid place-items-center`}><FdotSVG/>Loading</div></div>}
            ...
            <div className={`relative lg:pr-10 w-[50%] lg:min-w-[420px] max-[1250px]:order-1 max-lg:w-full`}>
                ...
                <div className={`w-full flex justify-end`}>
                    <p className={`text-secondary text-xl text-right max-[1250px]:text-left max-lg:text-base lg:max-w-[500px]`}>
...
//Mit Animationen
/*<section className={`w-full overflow-hidden relative grid place-items-center`}>
        <div id={"referenzen"} className={`id`}></div>
